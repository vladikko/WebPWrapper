...
namespace WebPWrapper.Encoder {
    ...
    public class WebPEncoderBuilder : IWebPEncoderBuilder {
        ...
        public const string _windowsDir = "libwebp-1.3.0-windows-x64";
        public const string _linuxDir = "libwebp-1.3.0-linux-x86-64";
        public const string _osxDir = "libwebp-1.3.0-mac-x86-64";
        public const string _osxARMDir = "libwebp-1.3.0-mac-arm64";
        /// <summary>
