...
namespace WebPWrapper
{
    ...
    public static class WebPExecuteDownloader
    {
        public const string WELL_KNOWN_WINDOWS_CLI_URL =
            "https://storage.googleapis.com/downloads.webmproject.org/releases/webp/libwebp-1.3.0-windows-x64.zip";
        ...
        public const string WELL_KNOWN_OSX_CLI_URL =
            "https://storage.googleapis.com/downloads.webmproject.org/releases/webp/libwebp-1.3.0-mac-x86-64.tar.gz";

        public const string WELL_KNOWN_OSX_ARM_CLI_URL =
            "https://storage.googleapis.com/downloads.webmproject.org/releases/webp/libwebp-1.3.0-mac-arm64.tar.gz";
